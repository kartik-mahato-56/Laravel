@include('common.header')
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="mb5 font-family-2"><b>Living Room</b></p>
                <p class="text-justify font-family-1">The Living room is supposed to be the showcase of what you are to the people who visit you. Hence we have exclusive specialist designing solutions towards this end wherein we venture to set a definite mood to your living space while incorporating expensive materials used in perfect symmetry with rich spicy colours and variety of textures. Other furniture and accessories are placed in perfect harmony with the design layout. From the placement of the furniture, selection of the upholstery and furnishings to abiding the theme & mood required for the living space with the latest –in- market trends, the specialist, specially designed the living area... Please both the host and the guest... Perfect bond guaranteed!! </p>
            </div>
            <div class="col-12">
                <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-1.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-1.jpg')}}" >
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-1.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-2.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-2.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-3.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-3.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-4.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-5.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-6.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-6.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-7.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-7.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-7.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-8.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-8.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-8.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/gallery-9.jpg')}}" data-src="{{asset('assets/images/gallery/gallery-9.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/gallery-9.jpg')}}">
                        </a>
                    </li>
                </ul>
            </div>
