@include('common.header')
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="mb5 font-family-2"><b>Showroom Interior</b></p>
                <p class="text-justify font-family-1">We have attained an esteemed position in the field of showroom designing through an enviable track record. We have already catered to a long list of kitchen chains, product display rooms etc with a wide spectrum of exquisite design layouts. With our expertise in designing we have designed showrooms for kitchen chains, product display rooms etc with a wide spectrum of exquisite design layouts. With our satisfied esteemed clients, we have attained a position of pride.</p>
            </div>
            <div class="col-12">
                <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/showroomRoom-1.jpg')}}" data-src="{{asset('assets/images/gallery/showroomRoom-1.jpg')}}" >
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/showroomRoom-1.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/showroomRoom-2.jpg')}}" data-src="{{asset('assets/images/gallery/showroomRoom-2.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/showroomRoom-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/showroomRoom-3.jpg')}}" data-src="{{asset('assets/images/gallery/showroomRoom-3.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/showroomRoom-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/showroomRoom-4.jpg')}}" data-src="{{asset('assets/images/gallery/showroomRoom-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/showroomRoom-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/showroomRoom-5.jpg')}}" data-src="{{asset('assets/images/gallery/showroomRoom-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/showroomRoom-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/showroomRoom-6.jpg')}}" data-src="{{asset('assets/images/gallery/showroomRoom-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/showroomRoom-6.jpg')}}">
                        </a>
                    </li>
                </ul>
            </div>
...
<!--/ End Footer -->
        ...
        <script src="j{{asset('assets/s/jquery-migrate.min.js')}}"></script>
        <!-- Popper JS-->
