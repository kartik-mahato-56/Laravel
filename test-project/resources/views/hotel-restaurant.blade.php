...
<body>
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="mb5 font-family-2"><b>Hotel & Restaurant Interior</b></p>
                <p class="text-justify font-family-1">We provide a host of hotel and restaurant designing and decoration services with a round the clock eye on every step of the processes, nullifying any mishaps. We meticulously design the hotel and restaurants providing an ambiance that invites the guest with great comfort and awesome feel. Every step of the process is monitored leaving no scope for any complaints. To execute the designing and decoration, we make the basic layout to design and draft for the hotel or restaurant and do construction which includes carpentry, lighting, interior and exterior designs.</p>
            </div>
            <div class="col-12">
                <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/hotelRoom-1.jpg')}}" data-src="{{asset('assets/images/gallery/hotelRoom-1.jpg')}}" >
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/hotelRoom-1.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/hotelRoom-2.jpg')}}" data-src="{{asset('assets/images/gallery/hotelRoom-2.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/hotelRoom-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/hotelRoom-3.jpg')}}" data-src="{{asset('assets/images/gallery/hotelRoom-3.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/hotelRoom-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/hotelRoom-4.jpg')}}" data-src="{{asset('assets/images/gallery/hotelRoom-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/hotelRoom-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/hotelRoom-5.jpg')}}" data-src="{{asset('assets/images/gallery/hotelRoom-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/hotelRoom-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/hotelRoom-6.jpg')}}" data-src="{{asset('assets/images/gallery/hotelRoom-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/hotelRoom-6.jpg')}}">
                        </a>
                    </li>
                </ul>
            </div>
...
<!--/ End Footer -->
        ...
        <!-- Owl Carousel JS-->
        <script src="{{asset('assets/js/owl.carousel.min.j')}}"></script>
        <!-- Waypoints JS-->
