...
<!-- including the header which contain all the css js linkds -->
...
<body>
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="mb5 font-family-2"><b>Customer Stories</b></p>
                <p class="text-justify font-family-1">Coming Soon!</p>
            </div>
<!--            <div class="col-12">
