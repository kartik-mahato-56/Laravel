@include('common.header')
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="mb5 font-family-2"><b>Dining Room</b></p>
                <p class="text-justify font-family-1">We offer a varied range of design choices for your dining room. The designs come in various colours and styles synchronizing with differing shapes and sizes of individual dining spaces. These design solutions of ours, also match the furnishings and overall tone of the interior of your home as whole. Such designs that make your room look spacious and bright to generate a desired ambiance. Our designs match the furnishings and overall tone of the interior dining spaces. The designs come in various colours and styles with a wide range of design choices to meet the client's taste, need and comfort. The designs make the area appear spacious and bright, perfect for relishing the favourites.</p>
            </div>
            <div class="col-12">
                <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-1.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-1.jpg')}}" >
                        <a href="">
                            <img class="{{asset('assets/img-responsive')}}" src="{{asset('assets/images/gallery/diningRoom-1.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" {{asset('assets/data-responsive="images/gallery/diningRoom-2.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-2.jpg')}}">
                        <a href="">
                            <img class="{{asset('assets/img-responsive')}}" src="{{asset('assets/images/gallery/diningRoom-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-3.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-3.jpg')}}">
                        <a href="">
                            <img class="{{asset('assets/img-responsive')}}" src="{{asset('assets/images/gallery/diningRoom-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-4.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/diningRoom-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-5.jpg')}}" data-src="images/gallery/diningRoom-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/diningRoom-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-6.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/diningRoom-6.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="images/gallery/diningRoom-7.jpg')}}" data-src="images/gallery/diningRoom-7.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/diningRoom-7.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-8.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-8.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/diningRoom-8.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/diningRoom-9.jpg')}}" data-src="{{asset('assets/images/gallery/diningRoom-9.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/diningRoom-9.jpg')}}">
                        </a>
                    </li>
                </ul>
            </div>
