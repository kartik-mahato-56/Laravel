              ...
              <div class="login-content">
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="login-form">
                    <h4 class="text-center">Replied Message</h4>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="reply_message"  value= id="" rows="5">{{$enquiry->reply_message}}</textarea>
                    </div>
             
                    <div class="mb-3 d-flex justify-content-center">
                        
                      <a href="{{route('enquiries')}}" class="btn btn-outline-success" roll="button">Back</a>
                    </div>
                  </div>
                </form>
