@include('common.header')
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="mb5 font-family-2"><b>Corporate & Office Interior</b></p>
                <p class="text-justify font-family-1">We understand the needs and vision of the corporate office requirements. Working in conjunction with them, keeping up the corporate identity, we design. These designs enable us in delivering the corporate with the design for the interiors that portrays their vision and entity. All essentials like judicious and harmonic use of the space and overall aesthetics are taken care of!</p>
            </div>
            <div class="col-12">
                <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/corporateRoom-1.jpg')}}" data-src="{{asset('assets/images/gallery/corporateRoom-1.jpg')}}" >
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/mages/gallery/corporateRoom-1.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/corporateRoom-2.jpg')}}" data-src="{{asset('assets/images/gallery/corporateRoom-2.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/corporateRoom-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/corporateRoom-3.jpg')}}" data-src="{{asset('assets/images/gallery/corporateRoom-3.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/corporateRoom-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/corporateRoom-4.jpg')}}" data-src="{{asset('assets/images/gallery/corporateRoom-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/corporateRoom-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/corporateRoom-5.jpg')}}" data-src="{{asset('assets/images/gallery/corporateRoom-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/corporateRoom-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/corporateRoom-6.jpg')}}" data-src="{{asset('assets/images/gallery/corporateRoom-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/corporateRoom-6.jpg')}}">
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-4 offset-lg-8 pull-right">
                        <div class="card">
                            <!-- Including the enquiry form to the index page -->
...
<!-- Footer -->
        ...
        <!-- Waypoints JS-->
        <script src="{{asset('assets/js/waypoints.min.j')}}s"></script>
        <!-- Slick Nav JS-->
