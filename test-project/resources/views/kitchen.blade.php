@include('common.header')
    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                <p class="text-uppercase font-24 mb5"><b class="color-orange">Kitchen</b></p>
                <p class="text-justify font-family-1 font-18">We all want our homes to look beautiful. It is one place where every corner should reflect comfort, style and perfection. Kitchen plays quite a significant role. However, today, modular kitchens have transformed the interior decor of house making. It enhances the appeal of your kitchen giving you an array of designs that perfectly suits your taste. There are a few points that one keeps in mind while designing the kitchen, like storage space, lighting, appliance space and the working triangle. With our experienced and highly skilled workforce we are committed to deliver excellent service along with an array of cabinet materials manufactured by us. Pick from a range of solid wood, lacquered glass, floral, acrylic, laminates and PU coated. We make sure that you your kitchen design perfectly cater to your requirement.</p>
            </div>
            <div class="col-12">
                <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row">
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-1.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-1.jpg')}}" >
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-1.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-2.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-2.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-3.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-3.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="images/gallery/kitchenRoom-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-4.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-5.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-6.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-6.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-7.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-7.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-7.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-8.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-8.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-8.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/kitchenRoom-9.jpg')}}" data-src="{{asset('assets/images/gallery/kitchenRoom-9.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/kitchenRoom-9.jpg')}}">
                        </a>
                    </li>
                </ul>
            </div>
